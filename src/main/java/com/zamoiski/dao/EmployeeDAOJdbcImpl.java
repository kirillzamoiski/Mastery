...
public class EmployeeDAOJdbcImpl implements EmployeeDAO {
    ...
    private final String INSERT = "INSERT INTO employee(first_name, last_name, department_id, job_title, gender, date_of_birth) " +
            " values(:firstName,:lastName,:departmentId,:jobTitle,:gender,:dateOfBirth)";
    private final String SELECT_ALL = "select * from employee";
    private final String FIND_BY_ID = "select * from employee where employee_id = :id";
    private final String DELETE_BY_ID = "delete * from employee where employee_id = :id";
